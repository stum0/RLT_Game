use crate::{
    gamelog::GameLog, CombatStats, Item, RunState, TileType, Viewshed, WantsToMelee,
    WantsToPickupItem, Monster,
};
...
pub fn player_input(gs: &mut State, ctx: &mut Rltk) -> RunState {
    match ctx.key {
        ...
        Some(key) => match key {
            ...
            VirtualKeyCode::Numpad3 | VirtualKeyCode::D => try_move_player(1, 1, &mut gs.ecs),

            VirtualKeyCode::Numpad1 | VirtualKeyCode::A => try_move_player(-1, 1, &mut gs.ecs),
